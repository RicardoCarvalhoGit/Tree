                ...
                <ul className={style.list}>
                    <li className={style.list_Item}>
                        <div className={style.list_Item_header}>
                            <img className={style.list_Icon} src="https://licensingcon.com.br/wp-content/uploads/2019/08/CocaCola.png" />
                        </div>
                    ...
                    <li className={style.list_Item}>
                        <div className={style.list_Item_header}>
                            <img className={style.list_Icon} src="https://fariart.com.br/blog/wp-content/uploads/2023/04/logo-fanta-2017.jpg" />
                        </div>
                        <div className={style.list_Item_Body}>
                            <span className={style.list_Item_Titule}>
                                POSIÇÃO 2°
                    ...
                    <li className={style.list_Item}>
                        <div className={style.list_Item_header}>
                            <img className={style.list_Icon} src="https://fariart.com.br/blog/wp-content/uploads/2023/03/pepsi-2014-logo-1.jpg" />
                        </div>
                        <div className={style.list_Item_Body}>
                            <span className={style.list_Item_Titule}>
                                POSIÇÃO 3°
